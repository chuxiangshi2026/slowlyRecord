/**
 * 内置知识包：高等数学·概率统计基础（由 public/knowledgebanks/math-probability.json 转换生成，请勿手改）
 */
...
const pack: KnowledgePack = {
  "id": "math-probability",
  "name": "高等数学·概率统计基础",
  "description": "排列组合、概率公式与常见分布入门 15 条",
  "ordered": false,
  "usableAsPeg": false,
  "items": [
    {
    ...
    },
    {
      ...
      "question": "几何概型",
      "answer": "P(A)=A 的度量（长度/面积/体积）÷ 总度量",
      "extras": {
        "说明": "结果无限多时用量度代替计数"
      }
    },
    {
      "id": "math-probability-6",
      "question": "条件概率",
    ...
    },
    {
      ...
      "question": "方差",
      "answer": "D(X)=E[(X-E(X))²]=E(X²)-[E(X)]²",
      "extras": {
        "说明": "衡量波动大小，标准差是方差的平方根"
      }
    },
    {
      "id": "math-probability-12",
      "question": "二项分布",
    ...
    },
    {
      ...
      "question": "大数定律",
      "answer": "试验次数足够多时，频率稳定在概率附近",
      "extras": {
        "说明": "抛硬币次数越多，正面比例越接近 1/2"
      }
    },
    {
      "id": "math-probability-15",
      "question": "中心极限定理",
      "answer": "大量独立随机变量之和近似服从正态分布",
      "extras": {
        "说明": "这解释了正态分布为何无处不在"
      }
    }
