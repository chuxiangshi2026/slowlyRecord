/**
 * 内置知识包：高等数学·线性代数基础（由 public/knowledgebanks/math-linalg.json 转换生成，请勿手改）
 */
...
const pack: KnowledgePack = {
  "id": "math-linalg",
  "name": "高等数学·线性代数基础",
  "description": "矩阵、行列式、向量与特征值入门 14 条",
  "ordered": false,
  "usableAsPeg": false,
  "items": [
    {
    ...
    },
    {
      "id": "math-linalg-6",
      "question": "行列式的几何意义",
      "answer": "二阶行列式 |ad-bc| = 两列向量张成的平行四边形面积",
      "extras": {
        "说明": "三阶对应平行六面体有向体积"
      }
    },
    {
      ...
      "answer": "A 可逆 ⟺ det(A)≠0",
      "extras": {
        "说明": "det(A)=0 时矩阵把空间压扁，信息丢失"
      }
    },
    {
      "id": "math-linalg-8",
      "question": "向量的线性运算",
      "answer": "加减：对应分量相加减；数乘：各分量同乘一个数",
      "extras": {
        "说明": "几何上是箭头平移拼接与缩放"
      }
    },
