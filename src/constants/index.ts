...
export {DEFAULT_INTERVALS, APP_KEY, KEY, FROM, TO, DB_KEY, DB_KEY_USER_SET, USAGE_LIMITS, DB_KEY_NUMBER_MEMORY, DB_KEY_DICTATION, DB_KEY_WORDBANK, DB_KEY_SHORTCUT_MEMORY, DB_KEY_LETTER_MEMORY, DB_KEY_PHONETIC_MEMORY, DB_KEY_KNOWLEDGE_MEMORY};
