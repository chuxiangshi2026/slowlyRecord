...
function getFallbackWords(type: WordBankType): Word[] {
  ...
  const fallbackData: Record<string, Array<{word: string; phonetic?: string; explains: string}>> = {
    ...
    'phrasal-verbs': [
      ...
      { word: 'come up', explains: 'v. 出现；发生' },
      { word: 'come about', explains: 'v. 发生；产生' },
      ...
      { word: 'get across', explains: 'v. 传达；讲清楚' },
      { word: 'get away with', explains: 'v. 侥幸成功；逃脱惩罚' },
      { word: 'give up', explains: 'v. 放弃；停止' },
      { word: 'go on', explains: 'v. 继续；发生' },
      { word: 'go out', explains: 'v. 出去；外出；熄灭' },
      ...
      { word: 'turn out', explains: 'v. 结果是；生产' },
      { word: 'work out', explains: 'v. 解决；锻炼' },
      { word: 'fall through', explains: 'v. 失败；落空' },
      { word: 'fall back on', explains: 'v. 依靠；退而求其次' },
      { word: 'hold on', explains: 'v. 坚持；稍等' },
      { word: 'hold up', explains: 'v. 举起；耽搁' },
      { word: 'keep on', explains: 'v. 继续；持续' },
      { word: 'show up', explains: 'v. 出现；露面' },
      { word: 'show off', explains: 'v. 炫耀；卖弄' },
      { word: 'stand out', explains: 'v. 突出；引人注目' },
      { word: 'turn down', explains: 'v. 拒绝；调小音量' },
    ],
    collocations: [
      ...
      { word: 'be supposed to', explains: '应该；理应' },
      { word: 'be used to', explains: '习惯于' },
      { word: 'be able to', explains: '能够；有能力' },
      { word: 'be likely to', explains: '很可能' },
      { word: 'be willing to', explains: '愿意；乐意' },
      { word: 'by the way', explains: '顺便说一下' },
      { word: "can't help doing", explains: '忍不住做' },
      { word: 'due to', explains: '由于；因为' },
      { word: 'had better do', explains: '最好做…' },
      { word: 'have difficulty doing', explains: '做…有困难' },
    ...
    idioms: [
      ...
      { word: 'make a difference', explains: '有影响；起重要作用' },
      { word: 'make a living', explains: '谋生；维持生计' },
      { word: 'make sense', explains: '有道理；讲得通' },
      { word: 'make sure', explains: '确保；确认' },
      ...
      { word: 'actions speak louder than words', explains: '行动胜于空谈' },
      { word: 'birds of a feather flock together', explains: '物以类聚' },
      { word: 'hit the books', explains: '用功读书' },
      { word: 'make ends meet', explains: '收支平衡；勉强糊口' },
      { word: 'go the extra mile', explains: '加倍努力' },
      { word: 'cut to the chase', explains: '开门见山' },
      { word: 'play it by ear', explains: '见机行事' },
      { word: 'call it a day', explains: '收工；今天就到这里' },
      { word: 'from scratch', explains: '从零开始' },
      { word: 'get cold feet', explains: '临阵退缩' },
      { word: 'burn the midnight oil', explains: '挑灯夜读' },
    ],
  };
